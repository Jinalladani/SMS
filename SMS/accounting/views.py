...
from accounting.resources import IncomeCategoryResource, ExpenseCategoryResource, SocietyMemberDetailsResource, MemberVenderDetailResource, IncomeExpenseLedgerResource
...
class IncomeExpenseLedgerUpdateView(LoginRequiredMixin, UpdateView):
    model= IncomeExpenseLedgerModel
    fields = ['date', 'type','amount','category_header','from_or_to_account','transaction_type','transaction_details','voucherNo_or_invoiceNo','remark']
